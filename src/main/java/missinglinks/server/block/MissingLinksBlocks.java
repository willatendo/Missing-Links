...
public class MissingLinksBlocks {
	...
	public static final BlockEntry<LeverBlock> ANDESITE_LEVER = REGISTRATE.block("andesite_lever", properties -> new LeverBlock(properties)).properties(properties -> properties.copy(Blocks.LEVER)).recipe((block, provider) -> ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, block.get()).pattern("#").pattern("%").define('#', Items.STICK).define('%', Blocks.ANDESITE).unlockedBy("has_item", provider.has(Blocks.ANDESITE)).save(provider)).blockstate((block, provider) -> provider.getVariantBuilder(block.get()).forAllStates(state -> {
		...
		return ConfiguredModel.builder().modelFile(powered ? provider.models().withExistingParent(block.getName() + "_on", provider.mcLoc("block/lever_on")).texture("particle", provider.mcLoc("block/andesite")).texture("base", provider.mcLoc("block/andesite")).texture("lever", provider.modLoc("block/andesite_lever")) : provider.models().withExistingParent(block.getName(), provider.mcLoc("block/lever")).texture("particle", provider.mcLoc("block/andesite")).texture("base", provider.mcLoc("block/andesite")).texture("lever", provider.modLoc("block/andesite_lever"))).rotationX(face == AttachFace.FLOOR ? 0 : (face == AttachFace.WALL ? 90 : 180)).rotationY((int) (face == AttachFace.CEILING ? facing : facing.getOpposite()).toYRot()).build();
	...
	public static final BlockEntry<LeverBlock> DIORITE_LEVER = REGISTRATE.block("diorite_lever", properties -> new LeverBlock(properties)).properties(properties -> properties.copy(Blocks.LEVER)).recipe((block, provider) -> ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, block.get()).pattern("#").pattern("%").define('#', Items.STICK).define('%', Blocks.DIORITE).unlockedBy("has_item", provider.has(Blocks.DIORITE)).save(provider)).blockstate((block, provider) -> provider.getVariantBuilder(block.get()).forAllStates(state -> {
		...
		AttachFace face = state.getValue(LeverBlock.FACE);
		boolean powered = state.getValue(LeverBlock.POWERED);
		return ConfiguredModel.builder().modelFile(powered ? provider.models().withExistingParent(block.getName() + "_on", provider.mcLoc("block/lever_on")).texture("particle", provider.mcLoc("block/diorite")).texture("base", provider.mcLoc("block/diorite")).texture("lever", provider.modLoc("block/diorite_lever")) : provider.models().withExistingParent(block.getName(), provider.mcLoc("block/lever")).texture("particle", provider.mcLoc("block/diorite")).texture("base", provider.mcLoc("block/diorite")).texture("lever", provider.modLoc("block/diorite_lever"))).rotationX(face == AttachFace.FLOOR ? 0 : (face == AttachFace.WALL ? 90 : 180)).rotationY((int) (face == AttachFace.CEILING ? facing : facing.getOpposite()).toYRot()).build();
	...
	public static final BlockEntry<LeverBlock> GRANITE_LEVER = REGISTRATE.block("granite_lever", properties -> new LeverBlock(properties)).properties(properties -> properties.copy(Blocks.LEVER)).recipe((block, provider) -> ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, block.get()).pattern("#").pattern("%").define('#', Items.STICK).define('%', Blocks.GRANITE).unlockedBy("has_item", provider.has(Blocks.GRANITE)).save(provider)).blockstate((block, provider) -> provider.getVariantBuilder(block.get()).forAllStates(state -> {
		...
		AttachFace face = state.getValue(LeverBlock.FACE);
		boolean powered = state.getValue(LeverBlock.POWERED);
		return ConfiguredModel.builder().modelFile(powered ? provider.models().withExistingParent(block.getName() + "_on", provider.mcLoc("block/lever_on")).texture("particle", provider.mcLoc("block/granite")).texture("base", provider.mcLoc("block/granite")).texture("lever", provider.modLoc("block/granite_lever")) : provider.models().withExistingParent(block.getName(), provider.mcLoc("block/lever")).texture("particle", provider.mcLoc("block/granite")).texture("base", provider.mcLoc("block/granite")).texture("lever", provider.modLoc("block/granite_lever"))).rotationX(face == AttachFace.FLOOR ? 0 : (face == AttachFace.WALL ? 90 : 180)).rotationY((int) (face == AttachFace.CEILING ? facing : facing.getOpposite()).toYRot()).build();
	...
	public static final BlockEntry<LeverBlock> COBBLED_DEEPSLATE_LEVER = REGISTRATE.block("cobbled_deepslate_lever", properties -> new LeverBlock(properties)).properties(properties -> properties.copy(Blocks.LEVER)).recipe((block, provider) -> ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, block.get()).pattern("#").pattern("%").define('#', Items.STICK).define('%', Blocks.COBBLED_DEEPSLATE).unlockedBy("has_item", provider.has(Blocks.COBBLED_DEEPSLATE)).save(provider)).blockstate((block, provider) -> provider.getVariantBuilder(block.get()).forAllStates(state -> {
		...
		AttachFace face = state.getValue(LeverBlock.FACE);
		boolean powered = state.getValue(LeverBlock.POWERED);
		return ConfiguredModel.builder().modelFile(powered ? provider.models().withExistingParent(block.getName() + "_on", provider.mcLoc("block/lever_on")).texture("particle", provider.mcLoc("block/cobbled_deepslate")).texture("base", provider.mcLoc("block/cobbled_deepslate")).texture("lever", provider.modLoc("block/cobbled_deepslate_lever")) : provider.models().withExistingParent(block.getName(), provider.mcLoc("block/lever")).texture("particle", provider.mcLoc("block/cobbled_deepslate")).texture("base", provider.mcLoc("block/cobbled_deepslate")).texture("lever", provider.modLoc("block/cobbled_deepslate_lever"))).rotationX(face == AttachFace.FLOOR ? 0 : (face == AttachFace.WALL ? 90 : 180)).rotationY((int) (face == AttachFace.CEILING ? facing : facing.getOpposite()).toYRot()).build();
	...
	public static final BlockEntry<LeverBlock> CALCITE_LEVER = REGISTRATE.block("calcite_lever", properties -> new LeverBlock(properties)).properties(properties -> properties.copy(Blocks.LEVER)).recipe((block, provider) -> ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, block.get()).pattern("#").pattern("%").define('#', Items.STICK).define('%', Blocks.CALCITE).unlockedBy("has_item", provider.has(Blocks.CALCITE)).save(provider)).blockstate((block, provider) -> provider.getVariantBuilder(block.get()).forAllStates(state -> {
		...
		AttachFace face = state.getValue(LeverBlock.FACE);
		boolean powered = state.getValue(LeverBlock.POWERED);
		return ConfiguredModel.builder().modelFile(powered ? provider.models().withExistingParent(block.getName() + "_on", provider.mcLoc("block/lever_on")).texture("particle", provider.mcLoc("block/calcite")).texture("base", provider.mcLoc("block/calcite")).texture("lever", provider.modLoc("block/calcite_lever")) : provider.models().withExistingParent(block.getName(), provider.mcLoc("block/lever")).texture("particle", provider.mcLoc("block/calcite")).texture("base", provider.mcLoc("block/calcite")).texture("lever", provider.modLoc("block/calcite_lever"))).rotationX(face == AttachFace.FLOOR ? 0 : (face == AttachFace.WALL ? 90 : 180)).rotationY((int) (face == AttachFace.CEILING ? facing : facing.getOpposite()).toYRot()).build();
	...
	public static final BlockEntry<LeverBlock> TUFF_LEVER = REGISTRATE.block("tuff_lever", properties -> new LeverBlock(properties)).properties(properties -> properties.copy(Blocks.LEVER)).recipe((block, provider) -> ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, block.get()).pattern("#").pattern("%").define('#', Items.STICK).define('%', Blocks.TUFF).unlockedBy("has_item", provider.has(Blocks.TUFF)).save(provider)).blockstate((block, provider) -> provider.getVariantBuilder(block.get()).forAllStates(state -> {
		...
		AttachFace face = state.getValue(LeverBlock.FACE);
		boolean powered = state.getValue(LeverBlock.POWERED);
		return ConfiguredModel.builder().modelFile(powered ? provider.models().withExistingParent(block.getName() + "_on", provider.mcLoc("block/lever_on")).texture("particle", provider.mcLoc("block/tuff")).texture("base", provider.mcLoc("block/tuff")).texture("lever", provider.modLoc("block/tuff_lever")) : provider.models().withExistingParent(block.getName(), provider.mcLoc("block/lever")).texture("particle", provider.mcLoc("block/tuff")).texture("base", provider.mcLoc("block/tuff")).texture("lever", provider.modLoc("block/tuff_lever"))).rotationX(face == AttachFace.FLOOR ? 0 : (face == AttachFace.WALL ? 90 : 180)).rotationY((int) (face == AttachFace.CEILING ? facing : facing.getOpposite()).toYRot()).build();
	...
	public static final BlockEntry<LeverBlock> DRIPSTONE_LEVER = REGISTRATE.block("dripstone_lever", properties -> new LeverBlock(properties)).properties(properties -> properties.copy(Blocks.LEVER)).recipe((block, provider) -> ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, block.get()).pattern("#").pattern("%").define('#', Items.STICK).define('%', Blocks.DRIPSTONE_BLOCK).unlockedBy("has_item", provider.has(Blocks.DRIPSTONE_BLOCK)).save(provider)).blockstate((block, provider) -> provider.getVariantBuilder(block.get()).forAllStates(state -> {
		...
		AttachFace face = state.getValue(LeverBlock.FACE);
		boolean powered = state.getValue(LeverBlock.POWERED);
		return ConfiguredModel.builder().modelFile(powered ? provider.models().withExistingParent(block.getName() + "_on", provider.mcLoc("block/lever_on")).texture("particle", provider.mcLoc("block/dripstone_block")).texture("base", provider.mcLoc("block/dripstone_block")).texture("lever", provider.modLoc("block/dripstone_lever")) : provider.models().withExistingParent(block.getName(), provider.mcLoc("block/lever")).texture("particle", provider.mcLoc("block/dripstone_block")).texture("base", provider.mcLoc("block/dripstone_block")).texture("lever", provider.modLoc("block/dripstone_lever"))).rotationX(face == AttachFace.FLOOR ? 0 : (face == AttachFace.WALL ? 90 : 180)).rotationY((int) (face == AttachFace.CEILING ? facing : facing.getOpposite()).toYRot()).build();
	...
	public static final BlockEntry<LeverBlock> SMOOTH_BASALT_LEVER = REGISTRATE.block("smooth_basalt_lever", properties -> new LeverBlock(properties)).properties(properties -> properties.copy(Blocks.LEVER)).recipe((block, provider) -> ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, block.get()).pattern("#").pattern("%").define('#', Items.STICK).define('%', Blocks.SMOOTH_BASALT).unlockedBy("has_item", provider.has(Blocks.SMOOTH_BASALT)).save(provider)).blockstate((block, provider) -> provider.getVariantBuilder(block.get()).forAllStates(state -> {
		...
		AttachFace face = state.getValue(LeverBlock.FACE);
		boolean powered = state.getValue(LeverBlock.POWERED);
		return ConfiguredModel.builder().modelFile(powered ? provider.models().withExistingParent(block.getName() + "_on", provider.mcLoc("block/lever_on")).texture("particle", provider.mcLoc("block/smooth_basalt")).texture("base", provider.mcLoc("block/smooth_basalt")).texture("lever", provider.modLoc("block/smooth_basalt_lever")) : provider.models().withExistingParent(block.getName(), provider.mcLoc("block/lever")).texture("particle", provider.mcLoc("block/smooth_basalt")).texture("base", provider.mcLoc("block/smooth_basalt")).texture("lever", provider.modLoc("block/smooth_basalt_lever"))).rotationX(face == AttachFace.FLOOR ? 0 : (face == AttachFace.WALL ? 90 : 180)).rotationY((int) (face == AttachFace.CEILING ? facing : facing.getOpposite()).toYRot()).build();
	...
	public static final BlockEntry<LeverBlock> END_STONE_LEVER = REGISTRATE.block("end_stone_lever", properties -> new LeverBlock(properties)).properties(properties -> properties.copy(Blocks.LEVER)).recipe((block, provider) -> ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, block.get()).pattern("#").pattern("%").define('#', Items.STICK).define('%', Blocks.END_STONE).unlockedBy("has_item", provider.has(Blocks.END_STONE)).save(provider)).blockstate((block, provider) -> provider.getVariantBuilder(block.get()).forAllStates(state -> {
		...
		AttachFace face = state.getValue(LeverBlock.FACE);
		boolean powered = state.getValue(LeverBlock.POWERED);
		return ConfiguredModel.builder().modelFile(powered ? provider.models().withExistingParent(block.getName() + "_on", provider.mcLoc("block/lever_on")).texture("particle", provider.mcLoc("block/end_stone")).texture("base", provider.mcLoc("block/end_stone")).texture("lever", provider.modLoc("block/end_stone_lever")) : provider.models().withExistingParent(block.getName(), provider.mcLoc("block/lever")).texture("particle", provider.mcLoc("block/end_stone")).texture("base", provider.mcLoc("block/end_stone")).texture("lever", provider.modLoc("block/end_stone_lever"))).rotationX(face == AttachFace.FLOOR ? 0 : (face == AttachFace.WALL ? 90 : 180)).rotationY((int) (face == AttachFace.CEILING ? facing : facing.getOpposite()).toYRot()).build();
	...
	public static final BlockEntry<LeverBlock> TERRACOTTA_LEVER = REGISTRATE.block("terracotta_lever", properties -> new LeverBlock(properties)).properties(properties -> properties.copy(Blocks.LEVER)).recipe((block, provider) -> ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, block.get()).pattern("#").pattern("%").define('#', Items.STICK).define('%', Blocks.TERRACOTTA).unlockedBy("has_item", provider.has(Blocks.TERRACOTTA)).save(provider)).blockstate((block, provider) -> provider.getVariantBuilder(block.get()).forAllStates(state -> {
		...
		AttachFace face = state.getValue(LeverBlock.FACE);
		boolean powered = state.getValue(LeverBlock.POWERED);
		return ConfiguredModel.builder().modelFile(powered ? provider.models().withExistingParent(block.getName() + "_on", provider.mcLoc("block/lever_on")).texture("particle", provider.mcLoc("block/terracotta")).texture("base", provider.mcLoc("block/terracotta")).texture("lever", provider.modLoc("block/terracotta_lever")) : provider.models().withExistingParent(block.getName(), provider.mcLoc("block/lever")).texture("particle", provider.mcLoc("block/terracotta")).texture("base", provider.mcLoc("block/terracotta")).texture("lever", provider.modLoc("block/terracotta_lever"))).rotationX(face == AttachFace.FLOOR ? 0 : (face == AttachFace.WALL ? 90 : 180)).rotationY((int) (face == AttachFace.CEILING ? facing : facing.getOpposite()).toYRot()).build();
